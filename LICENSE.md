...
MIT License. See `code/LICENSE` for the full text.

Copyright (c) 2026 Nicolas Van Eeckhout.
...
Please do not cite this work without contacting the author first (the manuscript is under pre-submission review). Once an arXiv identifier exists, cite the arXiv version; see `CITATION.cff`.
